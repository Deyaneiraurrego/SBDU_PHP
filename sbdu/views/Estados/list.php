        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  ...
                  <a type="button" data-toggle="modal"  data-target="#exampleModal<?php echo$Estado->IdEstado?>" href="?controller=estado&method=edit&IdEstado=<?php
                  echo $Estado->IdEstado?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
                  
                  <a href="?controller=estado&method=delete&IdEstado=
                      <?php echo $Estado->IdEstado?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
				    ...
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				          <span onclick="window.location.href='?controller=estado'"   aria-hidden="true">&times;</span>
				        </button>
				      </div>
				      <div class="modal-body">

				        <form action="?controller=estado&method=save" method="post" onsubmit="return validarArea();">
										<div class="form-group">
                      <label>Nombre Estado</label>
                      <textarea class="form-control" rows="3" id="NombreEstado" name="NombreEstado" placeholder="Descripcion breve estado"  required></textarea>
										</div>
