        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  ...
                  <a type="button" data-toggle="modal"  data-target="#exampleModal<?php echo $Cargo->IdCargo?>" href="?controller=cargo&method=edit&IdCargo=<?php
                  echo $Cargo->IdCargo?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
                  
                  <a href="?controller=cargo&method=delete&IdCargo=
                      <?php echo $Cargo->IdCargo?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        ...
				        <form action="?controller=cargo&method=save" method="post" onsubmit="return validarArea();">
										<div class="form-group">
                      <label>Nombre Cargo</label>
                      <textarea class="form-control" rows="3" id="NombreCargo" name="NombreCargo" placeholder="Descripcion breve Cargo"  required></textarea>
										</div>
