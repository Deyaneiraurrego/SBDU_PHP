      ...
      <div class="container-fluid">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $Incidencia->FechaRecibido?></td>
                <td><?php echo $Incidencia->FechaEntrega?></td>
                <td><?php echo $Incidencia->NombreTecnico?></td>
                <td><?php echo $Incidencia->user?></td>
                
                <td>


                  <a type="button" data-toggle="modal"  data-target="#exampleModal<?php echo $Incidencia->IdIncidencia?>" href="?controller=Incidencia&method=edit&IdIncidencia=<?php
                  echo $Incidencia->IdIncidencia?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
                  
                  <a href="?controller=Incidencia&method=delete&IdIncidencia=
                      <?php echo $Incidencia->IdIncidencia?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel">Nuevo Incidencia</h5>
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				          <span onclick="window.location.href='?controller=incidencia'"   aria-hidden="true">&times;</span>
				        </button>
				      </div>
				      <div class="modal-body">

				    <form action="?controller=incidencia&method=save" method="post" >

                    <div class="form-group">
                      <label>Fecha Recibido</label>
                      <input type="date" class="form-control" name="FechaRecibido" required>
					</div>
                    <div class="form-group">
                    ...
                    <div>
									<label>Nombre Tecnico</label>
									 <select name="NombreTecnico" class="form-control" required>
										 <option value="">Seleccione Usuario</option>

										  	<?php
												  foreach ($ConsTecs  as $ConsTec) 
											{
													 if ($ConsTec->IdUsuario == $data[0]->IdUsuarioFK)
													  {
												?>
												...
												?>
										 						<option  value="<?php echo $ConsTec->NombreUsuario ?>"><?php echo $ConsTec->NombreUsuario?></option>			
												<?php
															 }
											}
												?>
                    ...
                    <div>
									<label>Usuario.</label>
									 <select name="IdUsuarioFK" class="form-control" required>
										 <option value="">Seleccione Usuario</option>
										  	<?php
				      ...
				      <div class="modal-footer">
				      	<input type="button" value="Cancelar" class="btn btn-secondary" onclick="window.location.href='?controller=incidencia'" /> 
